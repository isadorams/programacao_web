...
<form method="POST" action="{{ route('usuario_alterar', ['id' => $u->id]) }}">
	...
	<div class="d-grid gap-2 col-6 mx-auto">
	  ...
	  <input type="text" class="form-control"  placeholder="Endereco do usuário"  name="endereco" id="endereco_id" value="{{ $u->endereco }}">
	</div>

	<div class="d-grid gap-2 col-6 mx-auto">
	  <label for="floatingInput">CEP:</label>
	  <input  type="tel" name="cep" class="form-control"  placeholder="cep"  name="cep" id="cep_id" value="{{$u->cep}}">
	</div>

	<div class="d-grid gap-2 col-6 mx-auto">
	  <label for="floatingInput">Cidade:</label>
	  <input type="text" class="form-control"  placeholder="Cidade"  name="cidade" id="cidade_id" value="{{ $u->cep }}">
	</div>

	<div class="d-grid gap-2 col-6 mx-auto">
	  <label for="floatingInput">Estado:</label>
	      <select name="estado" type="text" class="form-control"  placeholder="Estados" id="estados_id" value="{{ $u->estado }}">
	...
	<div class="d-grid gap-2 col-6 mx-auto">
	  <label for="floatingInput">Categoria:</label>
	      <select name="categoria" type="text" class="form-control"  placeholder="Categoria" id="id_categoria" value="{{ $u->categoria }}">
